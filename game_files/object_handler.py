...
class  ObjectHandler:
    def __init__(self, game):
        ...
        self.sprite_list = []
        self.npc_list = []
        self.npc_sprite_path = 'game_files/resources/sprites/npc'
        self.static_sprite_path = 'game_files/resources/sprites/static_sprites'
        self.anim_sprite_path = 'game_files/resources/sprites/animated_sprites'
